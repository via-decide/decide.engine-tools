...
CONSTRAINTS
Commit the Poisson Disk math, the slope-calculation logic, and the binary array packer separately. @GN8RBot MUST test the spatial math with heavy unit tests, committing the boundary-check logic independently.
