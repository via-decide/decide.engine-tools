...
CONSTRAINTS
Isolate the terrain-flattening math, the mesh-extrusion logic, and the dynamic UV calculator. Commit the math for intersecting a curve with a heightmap as an independent, TDD-backed PR.
