...
CONSTRAINTS
Commit the Toast system, the Meter math, and the SOS shader separately. @GN8RBot MUST test the sync between the hardware 'Confirmation Pulse' and the Web UI 'Toast' (targeting < 100ms lag).
