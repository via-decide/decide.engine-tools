...
TASK
Add a new standalone tool called citation-formatter in tools/citation-formatter/. Title: "Citation Formatter". Description: "Format citations in APA, MLA, Chicago styles.". Category: "researchers". The tool must contain: config.json, index.html, tool.js. The tool must be standalone, use vanilla JS, load shared.css and tool-storage.js. Register in shared/tool-registry.js importableToolDirs array. Add to router.js modularTools map. Ensure index.html dynamic render picks it up. Add to README.md tool list.
Add a new standalone tool called data-visualizer in tools/data-visualizer/. Title: "Data Visualizer". Description: "Paste CSV data, get chart visualizations.". Category: "researchers". The tool must contain: config.json, index.html, tool.js. The tool must be standalone, use vanilla JS, load shared.css and tool-storage.js. Register in shared/tool-registry.js importableToolDirs array. Add to router.js modularTools map. Ensure index.html dynamic render picks it up. Add to README.md tool list.
Add a new standalone tool called color-palette-generator in tools/color-palette-generator/. Title: "Color Palette Generator". Description: "Generate harmonious color palettes from a seed color.". Category: "creators". The tool must contain: config.json, index.html, tool.js. The tool must be standalone, use vanilla JS, load shared.css and tool-storage.js. Register in shared/tool-registry.js importableToolDirs array. Add to router.js modularTools map. Ensure index.html dynamic render picks it up. Add to README.md tool list.
