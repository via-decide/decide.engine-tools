(() => {
  ...
  const toolPathStaticMap = {
    ...
    'context-packager': 'apps/studyos/context-packager/index.html',
    'spec-builder': 'apps/studyos/spec-builder/index.html',
    'code-generator': 'apps/remixer/code-generator/index.html',
    'code-reviewer': 'apps/studyos/code-reviewer/index.html',
    'output-evaluator': 'apps/oracle/output-evaluator/index.html',
    'task-splitter': 'apps/matrix/task-splitter/index.html',
    'workflow-template-gallery': 'apps/remixer/workflow-template-gallery/index.html',
    'tool-search-discovery': 'apps/matrix/tool-search-discovery/index.html',
    'prompt-compare': 'apps/oracle/prompt-compare/index.html',
    'repo-improvement-brief': 'apps/studyos/repo-improvement-brief/index.html',
    'idea-remixer': 'apps/remixer/idea-remixer/index.html',
    'template-vault': 'tools/template-vault/index.html',
    'export-studio': 'tools/export-studio/index.html',
    'tool-router': 'apps/matrix/tool-router/index.html',
    'script-generator': 'apps/remixer/script-generator/index.html',
    promptalchemy: 'apps/oracle/promptalchemy/index.html',
    ...
    'revenue-forecaster': 'apps/oracle/revenue-forecaster/index.html',
